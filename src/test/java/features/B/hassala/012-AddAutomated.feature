Feature: As a user, I should be able to add automated transfer funding method
  ...
  Scenario: Add automated transfer to any created hassala
    ...
    And user selects transfer frequency as "Monthly"
